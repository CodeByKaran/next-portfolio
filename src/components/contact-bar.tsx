...
const ContactBar = () => {
  return (
    ...
    >
      ...
      <LinkIcon icon={<InstagramLogoIcon className="hover:scale-150 duration-100 ease-in"/>} link="https://www.instagram.com/karan_dev0/" />
      <LinkIcon icon={<LinkedInLogoIcon className="hover:scale-150 duration-100 ease-in"/>} link="https://www.linkedin.com/in/karan-kumar-ba84112b3" />
     
      <LinkIcon icon={<MailIcon className="hover:scale-150 duration-100 ease-in h-4 w-4"/>} link="karankumarascode@gmail.com" ismail={true} />
    </motion.div>
  );
};
